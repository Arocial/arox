...
def main(profile: str | None = None):
    ...
    if args.ui == "vercel_ai":
        from arox.apps.chat.io_adapters.vercel_ai import VercelStreamServer
        ...
        if args.ui == "text":
            from arox.apps.chat.io_adapters.text import TextIOAdapter

            io_adapter = TextIOAdapter()
        elif args.ui == "telegram":
            from arox.apps.chat.io_adapters.telegram import TelegramIOAdapter

            io_adapter = TelegramIOAdapter()
        elif args.ui == "feishu":
            from arox.apps.chat.io_adapters.feishu import FeishuIOAdapter
